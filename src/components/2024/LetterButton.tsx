...
export const LetterButton = ({ row, col, letter, selected, correct, isAnswer, onClickLetter }: LetterButtonProps) => {
    return (
        <button
            className={twMerge(
                ...
                correct ? "bg-green-700 text-white dark:bg-green-900 dark:text-word-light-grey animate-pop" : "",
            )}
            onClick={() => {
